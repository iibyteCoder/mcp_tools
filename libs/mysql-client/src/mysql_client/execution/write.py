...
from mysql_client.domain.enums import TransactionAction, WriteOutcome
from mysql_client.domain.errors import WriteExecutionError
from mysql_client.domain.results import ExecutionMetadata, WriteResult

if TYPE_CHECKING:
    from mysql_client.domain.requests import WriteRequest
    from mysql_client.ports.driver import DriverConnection
