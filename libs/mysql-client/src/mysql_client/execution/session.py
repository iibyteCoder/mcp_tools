...
from mysql_client.execution.compare import compare_results
from mysql_client.execution.read import ReadExecutor
from mysql_client.execution.write import WriteExecutor
...
from mysql_client.sql.policy import validate_execution_policy

if TYPE_CHECKING:
    from collections.abc import Coroutine

    from mysql_client.domain.configuration import MySqlConnectionConfig
    from mysql_client.domain.enums import CancellationReason
    from mysql_client.ports.cancellation import CancellationToken
    from mysql_client.ports.driver import DriverConnection, DriverFactory
...
class MySqlSession:
    ...
    async def execute_compare(self, request: CompareRequest) -> CompareResult:
        ...
        equal, differences = compare_results(left, right, request.key_columns, max_diff_samples)
